  ...
  <div class=\"col-md-2 col-sm-6 my-3 my-md-2\">
      <div class=\"card h-100\">
          ...
          <div class=\"card-footer p-2 pt-0 border-top-0 bg-transparent\">
              ...
              <div class=\"text-center\">
                <input type=\"submit\" id=\"add\" name=\"add\" value=\"Add to cart\" class=\"btn mt-auto\">
              </div>
              <input type=\"hidden\" name=\"\" class=\"pid\" value=\"$productid\">
              <input type=\"hidden\" name=\"\" class=\"pname\" value=\"$productname\">
              <input type=\"hidden\" name=\"\" class=\"pprice\" value=\"$productprice\">
              <input type=\"hidden\" name=\"\" class=\"pimage\" value=\"$productimg\">
              <input type=\"hidden\" name=\"\" class=\"pquantity\" value=\"$productquantity\">
              <input type=\"hidden\" name=\"\" class=\"punit\" value=\"$productunit\">
              </form>
          </div>
      </div>
  </div>
