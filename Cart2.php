								...
								<table class="shopping-cart-table table">
									...
									// cek apakah produk sudah ada dalam keranjang
										...
										for($a = 0; $a < $jumlah_isi_keranjang; $a++){
											$id_produk = $_SESSION['keranjang'][$a]['product'];
											$jml = $_SESSION['keranjang'][$a]['jumlah'];

											$isi = mysqli_query($koneksi,"select * from product where product_id='$id_produk'");
											...
											<tr>
												...
												<td class="details">
													<a href="produk_detail.php?id=<?php echo $i['product_id'] ?>"><?php echo $i['productName'] ?></a>
												<!-- <ul>
											...
											<td class="text-right"><a class="main-btn icon-btn" href="Cart_Remove.php?id=<?php echo $i['produk_id']; ?>&redirect=keranjang"><i class="fa fa-close"></i></a></td>
										</tr>
